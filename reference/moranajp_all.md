...
make_input(tbl, text_col, iconv, brk = "BP")
...
- option:
  ...
  A text. Options for mecab. "-b" option is already set by moranajp. To
  see option, use "mecab -h" in command (win) or terminal (Mac).
...
- dic:
  ...
  A text. Dictionary of web chamame. Only used when
  `method = "chamame"`. See
